...
<li title="Extracurricular Activities">
        ...
        <div id="content" style="height:1000px;">
            ...
            <li style='padding-top:2rem; padding-left:1rem; color:#000000'>Kindly make changes in the following documents:</li>
                <?php 

                    $querybox = "SELECT * FROM `submit_status` WHERE `APPLICATION_ID` = '$id'   ";
                    $queryboxresult = mysqli_query($conn,$querybox);
                    $rowquery = mysqli_fetch_array($queryboxresult);
                    if($rowquery['PERSONAL_QUERYBOX']!=NULL)echo "<li id='list' >".$rowquery['PERSONAL_QUERYBOX']."</li>";
                    if($rowquery['CONTACT_QUERYBOX']!=NULL)echo "<li id='list'>".$rowquery['CONTACT_QUERYBOX']."</li>";
                    if($rowquery['CLGBDS_QUERYBOX']!=NULL && $rowquery['CLGMDS_QUERYBOX']==NULL && $rowquery['CLGPHD_QUERYBOX']==NULL && $rowquery['CLGFELL_QUERYBOX']==NULL)
                    {
                        echo "<li id='list'>".$rowquery['CLGBDS_QUERYBOX']."</li>";
                    }
                    else if($rowquery['CLGMDS_QUERYBOX']!=NULL && $rowquery['CLGPHD_QUERYBOX']==NULL && $rowquery['CLGFELL_QUERYBOX']==NULL)
                    {
                        echo "<li id='list'>".$rowquery['CLGMDS_QUERYBOX']."</li>";
                    }
                    else if( $rowquery['CLGPHD_QUERYBOX']!=NULL && $rowquery['CLGFELL_QUERYBOX']==NULL)
                    {
                        echo "<li id='list'>".$rowquery['CLGPHD_QUERYBOX']."</li>";
                    }
                    else{
                        echo "<li id='list'>".$rowquery['CLGFELL_QUERYBOX']."</li>";
                    }

                    if($rowquery['SCHOLARSHIP_QUERYBOX']!=NULL)echo "<li id='list'>".$rowquery['SCHOLARSHIP_QUERYBOX']."</li>";
                    if($rowquery['BDSDOC_QUERYBOX']!=NULL)echo "<li id='list'>".$rowquery['BDSDOC_QUERYBOX']."</li>";
                    if($rowquery['PROGRESS_QUERYBOX']!=NULL)echo "<li id='list'>".$rowquery['PROGRESS_QUERYBOX']."</li>";
                    if($rowquery['ACADEMIC_QUERYBOX']!=NULL)echo "<li id='list'>".$rowquery['CONTACT_QUERYBOX']."</li>";
                    if($rowquery['EXTRACURRICULAR_QUERYBOX']!=NULL)echo "<li id='list'>".$rowquery['EXTRACURRICULAR_QUERYBOX']."</li>";
