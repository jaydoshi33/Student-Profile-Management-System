...
<div class="container" style="margin-top:2rem;">
  <div class="row">
  <h1 id="box">Scholarship </h1>
  </div>
  <form method="POST" action="scholarship_back.php" style="border:1px solid #f52929;border-radius:1.5rem;padding:3%;padding-top:3rem;">
  ...
  <div class="row">
          ...
          <label class="input-group-text" for="inputGroupSelect01">Scholarship Details</label>
          </div>
          <select class="custom-select" id="inputGroupSelect01" name="scholarship_name" required>
            <option selected value="">Choose...</option>
            <option value="1" name="Scholarship1">Scholarship1</option>
            <option value="2" name="Scholarship2">Scholarship2</option>
            <option value="3" name="Scholarship3">Scholarship3</option>
            <option value="4" name="Scholarship4">Scholarship4</option>
            <option value="5" name="Scholarship5">Scholarship5</option>
            <option value="6" name="Scholarship6">Scholarship6</option>
            <option value="7" name="No Scholarship">No Scholarship</option>
          </select>
          </div> 
          </div>
     </div>
  ...
  <div class="row">
        ...
        <div class="col-sm">
            ...
            <input type="text"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="agency" value="<?php echo $row['AGENCY_NAME']; ?>" required>
            </div>
        </div>
   ...
   <div class="row">
         <div class="col-sm">
            ...
            <input type="text"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="amount" value="<?php echo $row['SCHOLARSHIP_AMT']; ?>" required>
            </div>
         </div>
     </div>
