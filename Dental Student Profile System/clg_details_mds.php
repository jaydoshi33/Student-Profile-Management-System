...
$conn = mysqli_connect($dbServername,$dbUsername,$dbPassword,$dbName);
            ...
            $sql    = "SELECT * FROM college_mds WHERE ID='$id'";
...
<head>
    <meta charset="utf-8">
    <title>College Details MDS</title>
        ...
        <div class="sanskruti" style="height:1000px;">
            ...
            <ul class="list-unstyled components">            
                <li class="active" title="Home">
                    <a href="home.php" class="sidebar-header" style="height:50px;">
...
<div class="container" style="margin-top:2rem;">
  <div class="row">
  <h1 id="box">College Details MDS</h1>
  </div>
  <form style="border:1px solid #f52929;border-radius:1.5rem;padding:3%;padding-top:3rem;" method="POST" action="college_mds.php">
  ...
  <div class="row">
    ...
    <br>
     ...
     <div class="row">
     <div class="col-sm"></div>
     <button type="input" class="btn" >Submit</button>
     <div class="col-sm"></div>
     </div>
</form>
</div>
