...
if(isset($_GET['event_name'])){
  ...
  $sql = "DELETE FROM `academic_achievements` WHERE ID='$id' AND EMAIL_ID='$email' AND EVENT_NAME='$event_name' AND LEVEL='$level' AND PRESENTATION_TYPE='$presentation_type' AND PRIZE_WON='$prize' AND CERTIFICATE='$certi'";
  unlink($certi);
  unlink($prize);
...
<div class="container" style="margin-top:2rem;">
  ...
  <br>
        ...
        <div class="row">
                         ...
                         <input type="text"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="presentation_type" value="<?php echo $rows["PRESENTATION_TYPE"]; ?>" disabled>
                         </div>
                      </div>
 ...
 <div class="col-5"></div>
 <div class="col-4">
 <a href="academic_view.php?event_name=<?php echo $rows['EVENT_NAME'];?>&level=<?php echo $rows['LEVEL'];?>&presentation_type=<?php echo $rows['PRESENTATION_TYPE'];?>&prize=<?php echo $rows['PRIZE_WON'];?>&certi=<?php echo $rows['CERTIFICATE'];?>&id=<?php echo $id; ?>&email=<?php echo $email; ?> " class="btn">Delete</a>
 </div>
 <div class="col-3"></div>
 </div>
...
<center><a href="academic_achievement.php" class="btn">Back</a></center>
        </div>
</div>
<!--Wrapper ends-->
</body>
