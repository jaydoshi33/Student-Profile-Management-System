...
<div class="container" style="margin-top:2rem;">
  ...
  <form style="border:1px solid #f52929;border-radius:1.5rem;padding:3%;padding-top:3rem;" method="POST" action="mds_document_back.php" enctype="multipart/form-data">
    <br>
    <div class="row">
          <div class="col-sm">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="neet_admit">
          </div>
          </div>
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="neet_rank">
          </div>
          </div>
       ...
       <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="allotment_letter">
          </div>
          </div>
          <div class="col-sm">
          <div class="input-group mb-3">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="admission_letter">
          </div>
        </div>
    </div>
    ...
    <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="tenth_marksheet">
          </div>
          </div>
          <div class="col-sm">
          <div class="input-group mb-3">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="tenth_passing_certificate">
          </div>
        </div>
    </div>
    ...
    <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="twelth_marksheet">
          </div>
          </div>
          <div class="col-sm">
          <div class="input-group mb-3">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="twelth passing certificate">
          </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="first_bds_marksheet">
            </div>
            </div>
            <div class="col-sm">
                <div class="input-group mb-3">
                ...
                <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="second_bds_marksheet">
                </div>
            </div>
    </div>
    ...
    <div class="row">
                <div class="col-sm">
                    ...
                    <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="third_bds_marksheet">
                    </div>
                    </div>
                    <div class="col-sm">
                        <div class="input-group mb-3">
                        ...
                        <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="fourth_bds_marksheet">
                        </div>
                        </div>
    </div>
<br>
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="provision_certi">
            </div>
        </div>
            <div class="col-sm">
                <div class="input-group mb-3">
                ...
                <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="attempt_certi">
                </div>
                </div>
    </div>
<br>
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="bds_deg_certi">
            </div>
        </div>
            ...
            <div class="col-sm">  
                ...
                <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="clg_intern_certi">
                </div>
                </div>
    </div>
<br>
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="dci_recog_certi">
            </div>
            </div>
        </div>
        <br>
            ...
            <div class="col-sm-6">
                ...
                <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="dci_reg_certi">
                </div>
                </div>
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="college_leaving_certificate">
          </div>
          </div>
        </div>
    ...
    <br>
        <div class="row">
            ...
            <div class="col-sm-6"> 
                <div class="input-group mb-3">
                    ...
                    <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="migration_certificate">
                </div>
            </div>
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="disability_certificate">
          </div>
          </div>
          </div>
     ...
     <div class="col-sm"></div>
     <div class="col-sm">
    <a href="mds_viewing_docs.php" class="btn">View</a>
     </div>
     <div class="col-sm">
