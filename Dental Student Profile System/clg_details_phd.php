...
$conn = mysqli_connect($dbServername,$dbUsername,$dbPassword,$dbName);
            ...
            $sql    = "SELECT * FROM college_phd WHERE ID='$id'";
...
<head>
    <meta charset="utf-8">
    <title>College Details Phd</title>
...
<div class="container" style="margin-top:2rem;">
  <div class="row">
  <h1 id="box">College Details Phd</h1>
  </div>
  <form style="border:1px solid #f52929;border-radius:1.5rem;padding:3%;padding-top:3rem;" method="POST" action="college_phd.php">
    <br>
  <div class="row">
    ...
    <br>
     ...
     <div class="row">
          ...
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name_college_mds" value="<?php echo $row['NAME_COLLEGE_MDS']; ?>" required>
          </div>
          </div>
     </div>
     <div class="row">
          <div class="col-sm-6">
            ...
            <input type="text"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name_board_mds" value="<?php echo $row['NAME_BOARD_MDS']; ?>" required>
            </div>
         </div> 
          <div class="col-sm-6">
          <div class="input-group mb-3">
          ...
          <input type="number" min="2000" max="2050" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="year_mds" value="<?php echo $row['YEAR_MDS']; ?>" required>
          </div>
          </div>
     </div><br>
     <div class="row">
