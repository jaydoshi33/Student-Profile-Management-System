...
$conn = mysqli_connect($dbServername,$dbUsername,$dbPassword,$dbName);
            ...
            $sql    = "SELECT * FROM college_fellowship WHERE ID='$id'";
...
<head>
    <meta charset="utf-8">
    <title>College Details Fellowship</title>
...
<div class="container" style="margin-top:2rem;">
  <div class="row">
  <h1 id="box">College Details</h1>
  </div>
  <form style="border:1px solid #f52929;border-radius:1.5rem;padding:3%;padding-top:3rem;" method="POST" action="college_fellowship.php">
    <br>
  <div class="row">
    ...
    <br>
     ...
     <div class="row">
          ...
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name_college_bds" value="<?php echo $row['NAME_COLLEGE_BDS']; ?>" required>
          </div>
          </div>
     </div>
     <div class="row">
          <div class="col-sm-6">
            ...
            <input type="text"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name_board_bds" value="<?php echo $row['NAME_BOARD_BDS']; ?>" required>
            </div>
         </div> 
          <div class="col-sm-6">
          <div class="input-group mb-3">
          ...
          <input type="number" min="2000" max="2050" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="year_bds" value="<?php echo $row['YEAR_BDS']; ?>" required>
          </div>
          </div>
     </div><br>
     ...
     <div class="row">
          ...
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name_college_mds" value="<?php echo $row['NAME_COLLEGE_MDS']; ?>" >
          </div>
          </div>
     </div>
     <div class="row">
          <div class="col-sm-6">
            ...
            <input type="text"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name_board_mds" value="<?php echo $row['NAME_BOARD_MDS']; ?>" >
            </div>
         </div> 
          <div class="col-sm-6">
          <div class="input-group mb-3">
          ...
          <input type="number" min="2000" max="2050" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="year_mds" value="<?php echo $row['YEAR_MDS']; ?>" >
          </div>
          </div>
     </div><br>
     <div class="row">
     ...
     <div class="row">
          ...
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name_college_other" value="<?php echo $row['NAME_COLLEGE_OTHER']; ?>" >
          </div>
          </div>
     </div>
     <div class="row">
          <div class="col-sm-6">
            ...
            <input type="text"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name_board_other" value="<?php echo $row['NAME_BOARD_OTHER']; ?>" >
            </div>
         </div> 
          <div class="col-sm-6">
          <div class="input-group mb-3">
          ...
          <input type="number" min="2000" max="2050" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="year_other" value="<?php echo $row['YEAR_OTHER']; ?>" >
          </div>
          </div>
     </div>
     ...
     <div class="col-sm"></div>
     <div class="col-sm">
     <button type="submit" name="submit"  value="Submit" class="btn" onclick="alert('Successfully submitted')">Submit</button></div>
     <div class="col-sm"></div>
     <div class="col-sm"></div>
     </div>
