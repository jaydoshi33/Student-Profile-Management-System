...
$sql = "INSERT INTO academic_achievements(EMAIL_ID,ID,EVENT_NAME,LEVEL, PRESENTATION_TYPE, PRIZE_WON,CERTIFICATE)VALUES ('".$email."','".$id."','".$event_name."','".$level."','".$presentation_type."', '".$prizeDestination."','".$certiDestination."')";
$result=mysqli_query($conn,$sql);
if ($result){
	echo $sql;
    header('Location:academic_achievement.php');
}
else{
