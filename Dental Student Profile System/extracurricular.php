...
<body>
    <div class="wrapper">
        <nav id="sidebar">
        <div class="sanskruti" style="height:800px;">
...
<div class="container" style="margin-top:2rem;">
  ...
  <form style="border:1px solid #f52929;border-radius:1.5rem;padding:3%;padding-top:3rem;" method="POST" action="extracurricular_back.php" enctype="multipart/form-data">
  <div class="row">
            ...
            <div id="test">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <option value="district" name="district">District Level</option>
                                    <option value="zonal" name="zonal">Zonal Level</option>
                                    <option value="state" name="state">State Level</option>
                                    <option value="national" name="national">National Level</option>
                                    <option value="international" name="international">International Level</option>
                                    </select>
                        </div> 
                        </div>
                        <div class="col-sm">
              ...
              <div class="row" id="type">
                ...
                <select class="custom-select" id="inputGroupSelect01" name="event_type" required>
                  ...
                  <option value="sports" name="sport">Sport</option>
                  </select>
                </div> 
                </div>
                <div class="col-sm-1"></div>
    ...
    <br>
       ...
       -->
        ...
        <div class="row">
            <div class="col-3"></div>
            <div class="col-3">
            <a href="extracurricular_view.php" class="btn">View</a>
            </div>
