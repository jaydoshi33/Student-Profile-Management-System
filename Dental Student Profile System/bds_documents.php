...
$conn = mysqli_connect($dbServername,$dbUsername,$dbPassword,$dbName);
            ...
            $sql    = "SELECT * FROM bds_document WHERE ID='$id'";
...
<div class="container" style="margin-top:2rem;">
  <div class="row">
  <h1 id="box">Documents BDS</h1>
  </div>
  <form style="border:1px solid #f52929;border-radius:1.5rem;padding:3%;padding-top:3rem;" method="POST" action="bds_document_back.php" enctype="multipart/form-data" novalidate>
    ...
    <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="neet_admit" required >
          </div>
          </div>
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="neet_rank" required>
          </div>
          </div>
     ...
     <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="allotment_letter" required>
          </div>
          </div>
          <div class="col-sm">
          <div class="input-group mb-3">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="admission_letter" required>
          </div>
        </div>
    </div>
    ...
    <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="tenth_marksheet" required>
          </div>
          </div>
          <div class="col-sm">
          <div class="input-group mb-3">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="tenth_passing_certificate" required>
          </div>
        </div>
    </div>
    ...
    <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="twelth_marksheet" required>
          </div>
          </div>
          <div class="col-sm">
          <div class="input-group mb-3">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="twelth_passing_certificate" required>
          </div>
        </div>
    </div>
...
<br>    
    ...
    <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="college_leaving_certificate" required>
          </div>
          </div>
          <div class="col-sm">
          <div class="input-group mb-3">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="migration_certificate" required>
          </div>
        </div>
    </div>
<br>
    ...
    <div class="row">
          ...
          <input type="file" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="disability_certificate" required>
          </div>
          </div>
          </div>
...
<br>
     ...
     <div class="col-sm"></div>
     <div class="col-sm">
    <a href="bds_viewing_docs.php" class="btn">View</a>
     </div>
     <div class="col-sm">
